    ...
    return (
        <div className="w-11/12 mx-auto my-5 relative h-auto">
            <div className="grid grid-cols-2 mb-4">
                <h1 className="text-xl font-semibold text-justify dark:text-white">Lista dos condomínios</h1>
            </div>
                ...
                {condominiums.length > 0 ? (
                                            ...
                                            {condominium.streets && condominium.streets.length > 0 ? (
                                                <ul className="list-disc list-inside">
                                                    {condominium.streets.map((street) => (
                                                        <li key={street.id} className="dark:text-gray-200">
                                                            {street.name} - {street.lots.length > 0 ? `${street.lots.length} lotes` : "Sem lotes cadastrados"}
                                                        </li>
                                                    ))}
                                                </ul>
                                            ) : (
                    ...
                    <div>
                            <Table>
                                ...
                                <TableBody>
                                    {[...Array(5)].map((_, index) => (
                                        <TableRow key={index} className="hover:bg-gray-50 dark:hover:bg-gray-600">
